...
We bouwen een website die werkt op verschillende schermformaten en uiteenlopende apparaten. In het [vorige artikel]({{page.previousPage.relativeUrl}}) vormden we de informatiearchitectuur van de pagina en maakten we een basisstructuur.
