...
Le site que nous développons sera compatible avec plusieurs types d'appareil et tailles d'écran. Dans l'[article précédent]({{page.previousPage.relativeUrl}}), nous avons réalisé l'architecture d'information de la page et créé une structure de base.
